...
import seleniumImg from '../../../../assets/img/courses/mini/java-selenium.png';
...
export const CoursesSection = ({ listCourses }: IList) => {
  ...
  listCourses = [
    ...
    },
    {
      ...
      description:
        'Es un curso orientado a las mejores prácticas orientadas a las pruebas con Selenium',
      miniLogo: seleniumImg,
    },
  ];
